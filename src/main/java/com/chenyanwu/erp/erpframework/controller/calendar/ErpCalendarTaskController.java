...
@RequestMapping(value = "/erpcalendartask")
public class ErpCalendarTaskController {

    Logger logger = LoggerFactory.getLogger(this.getClass());
    @Autowired
    private ErpCalendarTaskService service;


    @RequestMapping(value = "/get", method = RequestMethod.GET)
    @ResponseBody
    public ResultBean<ErpCalendarTask> get(String id) {
        ErpCalendarTask item = (ErpCalendarTask) service.selectByPrimaryKey(id);
        if (item != null) {
    ...
    @ResponseBody
    public ResultBean<String> create(@RequestBody @Validated ErpCalendarTask item) {
    ...
    @ResponseBody
    public ResultBean<String> update(@RequestBody @Validated ErpCalendarTask item) {
    ...
    @ResponseBody
    public ResultBean<Integer> delete(@RequestBody ErpCalendarTask item) {
    ...
    @ResponseBody
    public ResultBean<List<CalendarTaskVo>> getErpCalendarTaskByParams(String roomId, Date sTime, Date eTime) {
        List<CalendarTaskVo> list = service.getErpCalendarTaskByParams(roomId, sTime, eTime);
